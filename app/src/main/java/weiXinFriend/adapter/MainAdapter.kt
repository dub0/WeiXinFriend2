...
import com.renyu.weixinedittext.WeinXinEditActivity
import dubo.weixinfriend.R
    ...
    inner class MainNormalViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun clickComment(position: Int) {
            itemView.tv_comment.setOnClickListener {
                (context as WeinXinEditActivity).showInputComment(itemView.tv_comment, position)
            }
        }
    }
